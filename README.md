...
Interactive static vocabulary-app prototype using the 105 collected learning cards. Browse, search, navigate, and edit mnemonic stories. Full cards are the default. An optional spaced-recall mode conceals card details until reveal, offers text/image hints, and schedules words from explicit recalled / hint / forgot ratings. No quiz, typed answer, or automatic mastery inference. Seven mnemonic illustrations are included (purloin, apoplectic, wend, enjoin, diaspora, caricatured, galvanize).
